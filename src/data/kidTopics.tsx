...
export const topics: Record<string, Topic> = {
  ...
  depression: {
    id: "depression",
    title: "Depression",
    subtitle: "Depression is more than feeling sad sometimes. It can make everything feel heavy or empty for a long time. You are not alone, and support helps.",
    icon: "🌫️",
    quickActions: [
      {
        title: "One Tiny Step",
        description: "Pick one small thing like drinking water or opening a window. Do just that.",
        time: 2,
      },
      {
        title: "Reach Out",
        description: "Send a short message to someone you trust. Even 'hi' counts.",
        time: 2,
      },
      {
        title: "Get Some Light",
        description: "Sit by a window or step outside for a few minutes of daylight.",
        time: 5,
      },
    ],
    skills: [
      {
        ...
        description: "Doing small things can slowly help your mood lift",
        steps: [
          "Make a list of activities you used to enjoy",
          "Pick one that takes 5 minutes or less",
          "Do it today even if you do not feel like it",
      ...
      },
      {
        ...
        description: "Depression is real and treatable. Telling someone is a strong step",
        steps: [
          "Choose a parent, counselor, teacher, or doctor",
          "Use simple words like 'I have been feeling really down for a while'",
          "Ask them to help you talk to a doctor or counselor",
          "If you ever think about hurting yourself, tell someone right away or call a helpline",
        ],
        time: 15,
      },
    ],
    videos: [
      {
        ...
        summary: "A simple explanation of depression and why it is not your fault",
      },
      {
        title: "Helpful Tips for Depression",
        url: "https://www.youtube.com/embed/Vs-MyQgfH3A",
        summary: "Coping skills for managing big, heavy feelings",
      },
    ],
    journalPrompts: [
      "What is one small thing that felt okay today?",
      "Who is one person I could tell how I am feeling?",
      "What would I want a friend to know if they felt this way?",
    ],
  },
  eating: {
    id: "eating",
    title: "Food and Eating Worries",
    subtitle: "Sometimes thoughts about food, eating, or your body can feel really stressful. You deserve support and a kind relationship with food.",
    icon: "🍎",
    quickActions: [
      {
        title: "Pause and Breathe",
        description: "Take three slow breaths before making a food choice when you feel stressed.",
        time: 1,
      },
      {
        title: "Tell Someone Safe",
        description: "Share with a trusted adult that food has been on your mind a lot.",
        time: 5,
      },
      {
        title: "Step Away From Comparisons",
        description: "Close any app or page comparing bodies, food, or diets right now.",
        time: 2,
      },
    ],
    skills: [
      {
        title: "Notice Food Thoughts Without Judgment",
        description: "Understanding patterns is the first step to getting help",
        steps: [
          "When a strong food or body thought comes, write it down",
          "Note the time and what was happening",
          "Do not judge the thought, just notice it",
          "Show your notes to a trusted adult or counselor",
        ],
        time: 5,
      },
      {
        title: "Ask a Trusted Adult for Help",
        description: "Eating worries are real and treatable. You do not have to handle this alone",
        steps: [
          "Pick an adult you trust like a parent, school counselor, or doctor",
          "Tell them simply: 'I have been having a hard time with food and eating'",
          "Ask them to help you talk to a doctor",
          "Remember reaching out is brave, not weak",
        ],
        time: 15,
      },
    ],
    videos: [
      {
        ...
        url: "https://www.youtube.com/embed/UEsdMW4ZQfQ",
        summary: "Learn what eating disorders are and why getting help matters",
      },
      {
        title: "Building a Healthy Body Image",
        url: "https://www.youtube.com/embed/pdjaxS4ME2A",
        summary: "Tips to feel more confident and kind toward yourself",
      },
    ],
    journalPrompts: [
      "How did I feel about food today?",
      "What does my body need to feel cared for?",
      "Who could I trust to talk to about this?",
    ],
  },
  other: {
    id: "other",
