...
export function getDidYouKnow() {
  // Kid-friendly facts. Each one is general enough to be true and safe.
  // Avoid invented statistics or medical claims.
  const facts = [
    "Your brain stays busy even while you sleep. It sorts through what you learned that day 🧠",
    "A long hug can help your body feel calmer and safer 🤗",
    "Writing down your worries can help them feel smaller and easier to handle ✏️",
    "Laughing is good exercise for your lungs and your mood 😄",
    "Slow, deep breaths can help your heart slow down when you feel stressed 🌬️",
    "Your brain keeps growing and changing well into your twenties 🌱",
    "Spending time outside in nature can help you feel calmer 🌿",
    "Listening to music you love can lift your mood 🎵",
    "Talking about your feelings can make tough problems easier to work through 💬",
    "Moving your body, like running or dancing, is good for your brain too 🏃",
    "Saying thank you, out loud or in a note, can lift your mood and the other person's 💌",
    "Your brain uses a lot of energy every day. Food and rest help it do its job ⚡",
    "Helping someone else can actually make YOU feel happier too 🤝",
    "Building a new habit takes time. Be patient with yourself 📅",
    "Crying is okay. It's one of the ways your body lets out big feelings 💧",
    "Many dogs can sense when you're upset and will come to comfort you 🐕",
    "Your brain has tons of thoughts every day. No wonder it sometimes feels tired 💭",
    "Drinking enough water helps your body and your mood feel better 💧",
    "Reading a book, even for a few minutes, can help you feel calmer 📚",
    "The colour blue is often used in calm, peaceful places. Many people find it soothing 💙",
    "Spending time with pets can help you feel calm and less alone 🐱",
    "Drawing, music, and writing are great ways to express how you feel 🎨",
    "Getting enough sleep helps you remember things and handle emotions better 😴",
    "Talking kindly to yourself, like you would to a friend, really does help 💛",
    "Walking in nature can give your busy mind a break 🌲",
    "Those 'butterflies' in your stomach are real. Your gut and brain talk to each other 🦋",
    "Noticing things you're grateful for can train your brain to spot more good things ✨",
    "It's normal to have bad days. Even the happiest people have them 🌦️",
    "There has only ever been one YOU in the whole history of the universe 🌟",
    "Big feelings always pass, even when they feel huge in the moment 🌊",
    "Naming a feeling out loud, like 'I feel nervous,' can make it feel a little smaller 🏷️",
    "Sunlight in the morning can help your body wake up and sleep better at night ☀️",
    "Stretching can help release tension your body has been holding 🧘",
    "Asking for help is a sign of strength, not weakness 💪",
    "Your feelings are information. They tell you what matters to you 💡",
  ];
