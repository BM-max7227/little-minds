const emotionalWords = [
  ...
  { word: "Content", definition: "A quiet kind of happy — when you feel like things are good enough just as they are.", example: "Like sitting with your family after dinner, not doing anything special, but feeling warm inside." },
  ...
  { word: "Grief", definition: "Deep sadness that comes when you lose someone or something very important to you.", example: "Like when a grandparent passes away and the world feels different without them." },
  ...
  { word: "Triggered", definition: "When something reminds you of a bad experience and strong feelings come rushing back.", example: "Like hearing a loud noise that reminds you of a scary moment." },
  ...
  { word: "Panicked", definition: "A sudden rush of fear that makes your heart race and your body feel like it needs to escape.", example: "Like when you can't find your phone and for a moment everything feels urgent." },
  ...
  { word: "Numb", definition: "When you feel nothing at all — like your emotions have been turned off.", example: "Like after hearing really bad news and feeling like you're watching your life from outside your body." },
...
export function getDidYouKnow() {
  const facts = [
    ...
    "Your brain uses 20% of all the energy your body makes — it works hard for you! ⚡",
