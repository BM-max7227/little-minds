...
type ActionItem = (QuickAction | Skill) & { topicId: string; topicTitle: string; type: "quick" | "skill" };
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Find quick actions and skills based on how much time you have and what you're feeling
          </p>
        </div>
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Button
                variant={feelingFilter === null ? "default" : "outline"}
                size="sm"
