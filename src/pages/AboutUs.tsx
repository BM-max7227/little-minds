      ...
      <main className="flex-1 py-12">
        <div className="container px-4 max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none mb-12 space-y-6">
            ...
            <p>
              This is a personal project — not a registered charity, nonprofit organization, or government entity. It was made only to share knowledge, tools, and hope. Everything here is free to use and designed with kindness first.
            </p>
