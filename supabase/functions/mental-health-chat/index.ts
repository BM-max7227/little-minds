...
- The logo is a clean, modern icon of a brain that is also shaped like a tree, made of leaf-like shapes, in a single dark colour, with the words "LITTLE MINDS" shown beside or below it. It represents growth, learning, and looking after young minds. Do NOT describe it as a heart, a face, a smiley, or yellow — it is a brain/tree icon, not a heart. It appears at the top of every page, and clicking it returns to the home page. If you are ever unsure of a visual detail, keep the description simple ("a brain/tree icon with the Little Minds name") rather than inventing colours or shapes.
